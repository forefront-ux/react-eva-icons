...
const prepare = function () {
    ...
    fs.copySync(
        ...
        path.resolve(__dirname, '../src/icons/eva-icons/webpack.evacss.config.js')
    );
...
const clearSubmodule = function() {
    const packageBuildDirectory = path.resolve(__dirname, '../src/icons/eva-icons/package-build')
    fs.emptyDirSync(packageBuildDirectory);
    fs.rmdirSync(packageBuildDirectory);
    console.log('rmdir src/icons/eva-icons/package-build success!');
}

const post = function() {
    moveGeneratedCssFile();
    fs.removeSync(path.resolve(__dirname, '../src/icons/eva-icons/webpack.evacss.config.js'));
    console.log('rm src/icons/eva-icons/webpack.evacss.config.js success!');
}
